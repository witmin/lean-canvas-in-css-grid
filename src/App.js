            ...
            <div className="canvas">
                <div className="first row">
                    ...
                    <div className="box one problem">
                        ...
                        <div className="filling-order" title="Suggested filling order">1</div>
                    </div>
                    ...
                    <div className="box two solution">
                        ...
                        <div className="filling-order" title="Suggested filling order">4</div>
                    </div>
                    ...
                    <div className="box three key-metrics">
                        ...
                        <div className="filling-order" title="Suggested filling order">8</div>
                    </div>
                    ...
                    <div className="box four uni-val-prop">
                        ...
                        <div className="filling-order" title="Suggested filling order">3</div>
                    ...
                    <div className="box five unfair-advantage">
                        ...
                        <div className="filling-order" title="Suggested filling order">9</div>
                    </div>
                    ...
                    <div className="box six channels">
                        ...
                        <div className="filling-order" title="Suggested filling order">5</div>
                    </div>
                    ...
                    <div className="box seven customer segments">
                        ...
                        <div className="filling-order" title="Suggested filling order">2</div>
                    </div>
                ...
                <div className="second row">
                    ...
                    <div className="box eight cost-structure">
                        ...
                        <div className="filling-order" title="Suggested filling order">7</div>
                    </div>
                    ...
                    <div className="box nine revenue-streams">
                        ...
                        <div className="filling-order" title="Suggested filling order">6</div>
                    </div>
